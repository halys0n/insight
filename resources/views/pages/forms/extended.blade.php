                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input class="bootstrap-switch" type="checkbox" data-toggle="switch" checked=""
                                            data-on-color="default" data-off-color="default" data-on-label="ON"
                                            data-off-label="OFF">
                                        <input class="bootstrap-switch" type="checkbox" data-toggle="switch"
                                            data-off-color="default" data-on-color="default" data-on-label="ON"
                                            data-off-label="OFF">
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <input class="bootstrap-switch" type="checkbox" data-toggle="switch"
                                            data-off-color="primary" data-on-color="primary">
                                    </div>
                                    <div class="col-md-4">
