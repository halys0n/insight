                            ...
                            <form method="post" action="{{ route('tag.store') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('color') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="color" style="height: 50px;" name="color" id="input-name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Color') }}" value="{{ old('color') }}" required>
